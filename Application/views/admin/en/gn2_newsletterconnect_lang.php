...
$aLang = array(
    ...
    'GN2_NEWSLETTERCONNECT_API_SIGNUPSETUP_GENERAL'         => 'ID Sign-In General',
    'GN2_NEWSLETTERCONNECT_API_SIGNOFFSETUP_GENERAL'        => 'ID Sign-Off General',
    'GN2_NEWSLETTERCONNECT_API_SIGNUPSETUP_ACCOUNT'         => 'ID Sign-In (Customeraccount)',
    'GN2_NEWSLETTERCONNECT_API_SIGNOFFSETUP_ACCOUNT'        => 'ID Sign-Off (Customeraccount)',
    'GN2_NEWSLETTERCONNECT_API_CONFIG'                      => 'API-Configuration',
    'GN2_NEWSLETTERCONNECT_API_IPS'                         => 'IP-Adresses allowed to call by the voucher / profile manager APIs: <span>(one per Zeile)</span>',
    'GN2_NEWSLETTERCONNECT_VOUCHERSERIES'                   => 'Coupon series:',
    'GN2_NEWSLETTERCONNECT_YOURIP'                          => 'Your IP-Address: ',
